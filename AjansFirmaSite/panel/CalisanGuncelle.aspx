<%@ Page Title="" Language="C#" MasterPageFile="~/panel/Panel.Master" AutoEventWireup="true" CodeBehind="CalisanGuncelle.aspx.cs" Inherits="AjansFirmaSite.panel.CalisanGuncelle" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="col-md-4">
		...
		<div class="form-group">	
			<asp:Label CssClass="control-label" Text="resim" runat="server" />
