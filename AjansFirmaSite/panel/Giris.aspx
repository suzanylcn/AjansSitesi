<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Giris.aspx.cs" Inherits="AjansFirmaSite.panel.Giris" %>
		...
		<div>
			<div class="formclass">
				...
				<div class="text-kutu">
					...
					<asp:TextBox class="form-textbox" ID="txtkullaniciAdi" placeholder="Kullanıcı Adı Giriniz..." runat="server"></asp:TextBox>
				</div>
